...
def check_all_command_guards(command: str, env_type: str,
    ...
    if is_gateway or is_ask:
        ...
        # Redact secrets in user-facing approval copy. The raw command remains
        # in this tool invocation for execution after approval; the fallback
        # pending request and Mini App bridge only need display/decision data.
        from agent.redact import redact_sensitive_text
