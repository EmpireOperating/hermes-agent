...
KANBAN_GUIDANCE = (
    ...
    "When `kanban.supervisor_profile` is configured, completion automatically "
    "routes your handoff to that supervisor instead of marking the task done; "
    "use `kanban_complete` normally and let the gate handle review. Otherwise, "
    "if your output is a code change that needs human review before counting "
    "as merged/done (most coding tasks), drop the "
